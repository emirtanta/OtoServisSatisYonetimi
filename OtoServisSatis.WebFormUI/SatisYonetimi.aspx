...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:Button ID="btnGuncelle" runat="server" Text="Güncelle" OnClick="btnGuncelle_Click" style="width: 77px" />
        <asp:Button ID="btnSil" runat="server" Text="Sil" ValidationGroup="sil" OnClick="btnSil_Click" />
                </td>
            </tr>
        </table>
